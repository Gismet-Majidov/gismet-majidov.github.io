...
![light mode only](/assets/img/favicons/android-chrome-512x512.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/img/favicons/android-chrome-512x512.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }
